...
class S3ToEC2Stack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        security_group = ec2.SecurityGroup.from_security_group_id(self, "launch-wizard-alon", security_group_id="sg-04b45d6bc7f9fe45a")
        ...
        lambda_function.add_event_source(lambda_event_sources.S3EventSource(bucket, events=[s3.EventType.OBJECT_CREATED]))
